...
<body>
  <div class="container">
    <h2 class="text-center" style="margin-top: 50px;">Country States Citys</h2>
    <br><br>
    <div class="row">
      ...
      <!-- success message to display after uploading image -->
          ...
          <!-- validation message to display after form is submitted -->
             ...
             ?>    
             <!-- image upload form      -->
         <form id="form" role="Form" method="post" action="<?php echo base_url(); ?>dashboard/city-add" enctype="multipart/form-data">
